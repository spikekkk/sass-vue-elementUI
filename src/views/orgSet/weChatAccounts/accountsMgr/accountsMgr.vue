<template>
  <div class="accounts_mgr">
    ...
    >
      <div class="wrapa">
        <img src="http://img.ishanshan.com/gimg/user/n///260966321812930561.png" alt="">
        <div class="line"/>
        <img src="http://img.ishanshan.com/gimg/user/n///260966379308449793.png" alt="">
        <div class="line"/>
        <img src="http://img.ishanshan.com/gimg/user/n///260966412846104577.png" alt="">
      </div>
      <div class="wrapb">
      ...
      <div style="width: 528px;margin:0 auto">
        ...
        <div class="wxts" style="width:390px;margin-bottom:50px">
        ...
        <div class="nowB" @click="openDialog('set')">立即绑定公众号</div>
      </div>
    ...
    <div v-if="isOpenWx=='1'">
      <div class="wrap">
        <img src="http://img.ishanshan.com/gimg/user/n///260964290427617281.png" alt="">
        <div class="line"/>
        <img src="http://img.ishanshan.com/gimg/user/n///260964290427617281.png" alt="">
        <div class="line"/>
        <img src="http://img.ishanshan.com/gimg/user/n///260964052325367809.png" alt="">
      </div>
      <div class="wraps">
        <div>绑定公众号</div>
        <div>审核</div>
      ...
      <div class="wrapMiddle">
        <div class="middleSame">
          <div class="names" style="margin-left:16px">公众号昵称</div>
          <div class="lines" style="display:flex;justify-content: space-between">
            <span class="nameT">{{ weChatName }}</span>
            <span style="color:#1D9DF2;cursor:pointer" @click="openDialog('set')">更换公众号</span>
          </div>
        </div>
        <div class="middleSame">
          <div class="names" style="margin-left:49px">APPID</div>
          <div class="lines" style="color:#333">{{ weChatId }}</div>
        </div>
        <div class="middleSame">
        ...
        <div class="wxts">
          ...
          <div class="wordF">
            <span class="yuan"/>
            <span class="con">如果使用过程中发现接口异常，请点击此<span style="color:#1D9DF2;cursor:pointer" @click="openDialog('set')">重新授权</span>试试</span>
          </div>
          <div class="wordF">
            <span class="yuan"/>
            <span class="con">如果想换回“闪闪管家”公众号，请<span style="color:#1D9DF2;cursor:pointer" @click="openDialogd('buy')">联系客服</span></span>
          </div>
        </div>
      </div>
      <!-- <el-form>
    ...
    >
      ...
      <div v-if="switchOnOff==='power'">
        <p class="wrapALL">
          ...
          ><span class="titleS" style="margin-bottom:25px">请在新窗口完成微信授权</span>
        </p>
        <!-- <p class="set_content">
          检测到有微游戏正在进行，继续绑定公众号会导致用户数据丢失！请等微游戏结束后再设置！
        </p> -->
      ...
      <div v-if="switchOnOff==='fail'">
        ...
        <p class="wrapALL">
          <img
            ...
            alt=""
            style="margin-bottom:25px"
          ><span class="titleS" style="margin-bottom:25px">授权失败、请重试</span>
        </p>
        <div class="fail_btn">
          <el-button
            @click="closeDialog"
