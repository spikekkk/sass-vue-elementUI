      ...
      <div style="margin-bottom:14px">
        <el-form label-width="100px">
          ...
          >
            ...
            <div style="color:rgba(0,0,0,.43);font-size:12px">最多3张(支持png、jpg、jpeg、gif格式的图片，不大于10M。支持mp4格式的视频，不大于80M)</div>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    stuClassImgSuccess(response, file, fileList, item, index) {
      ...
      if (this.classTerachImg[index].classStuList.length === 3) {
        this.$forceUpdate()
        item.classStuVisible = true
      }
    },
    ...
    stryClassSuccess(response, file, fileList, item, index) {
      ...
      if (this.classTerachtryStu[index].tryClassList.length === 3) {
        this.$forceUpdate()
        item.classStuVisible = true
      }
    },
